...
tankerImage.src = 'https://i.ibb.co/TBybGk5/fish-swim-left.png';
...
class Player {
    ...
    draw(){
        ...
        //ctx.fill();
        if (this.x >= mouse.x){
            ctx.drawImage(tankerImage, this.frameX * this.spriteWidth, this.frameY * this.spriteHeight, this.spriteWidth, this.spriteHeight, 0 - 60, 0 - 45, this.spriteWidth * 0.8, this.spriteHeight * 0.8);
        } else {
